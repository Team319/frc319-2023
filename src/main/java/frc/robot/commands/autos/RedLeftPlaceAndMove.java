...
public class RedLeftPlaceAndMove extends SequentialCommandGroup {

  Trajectory redLeftPlaceAndMove = Robot.drivetrain.loadTrajectoryFromFile("placeandmoveredleft");

  /** Creates a new RedLeftPlaceAndMove. */
  public RedLeftPlaceAndMove() {
