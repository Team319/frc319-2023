...
public class BlueRight extends SequentialCommandGroup {
  ...
  Trajectory blueRightCharge1 = Robot.drivetrain.loadTrajectoryFromFile("bluerightcharge1");
  Trajectory blueRightCharge2 = Robot.drivetrain.loadTrajectoryFromFile("bluerightcharge2");
  ...
  public BlueRight() {
    ...
    addCommands(
      ...
      Commands.parallel(
        new InstantCommand(()->Robot.drivetrain.resetOdometry(blueRightCharge1.getInitialPose())),
        Robot.drivetrain.createCommandForTrajectory(blueRightCharge1, false),
      ...
      Commands.parallel(Robot.drivetrain.createCommandForTrajectory(blueRightCharge2, false), 
                              Commands.sequence( 
