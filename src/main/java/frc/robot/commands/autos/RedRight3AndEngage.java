...
public class RedRight3AndEngage extends SequentialCommandGroup {

  Trajectory redRight3Engage1 = Robot.drivetrain.loadTrajectoryFromFile("redright2andcharge1Maine");
  Trajectory redRight3Engage2 = Robot.drivetrain.loadTrajectoryFromFile("redright2andcharge2Maine");
  Trajectory redRight3Engage3 = Robot.drivetrain.loadTrajectoryFromFile("redright3engage3Maine");
  //Trajectory redRight3Engage4 = Robot.drivetrain.loadTrajectoryFromFile("redright3gamepiece42cubeMaine");
  
  /** Creates a new RedRight3AndEngage. */
  public RedRight3AndEngage() {
    ...
    addCommands(
      ...
      Commands.parallel(
        ...
        Commands.sequence(
          Commands.parallel(
            Robot.drivetrain.createCommandForTrajectory(redRight3Engage3, false),
            Commands.sequence(
              Commands.race(new FloorCollect(), new WaitCommand(3)),
              new GoHome()
            )
        )),
