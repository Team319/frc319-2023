...
public class BlueLeft3AndEngage extends SequentialCommandGroup {
  ...
  Trajectory blueLeft3Engage3 = Robot.drivetrain.loadTrajectoryFromFile("blueleft3engage3");
  ...
  public BlueLeft3AndEngage() {
    ...
    addCommands(
      ...
      Commands.parallel(
        ...
        Commands.sequence(
          Commands.parallel(
            Robot.drivetrain.createCommandForTrajectory(blueLeft3Engage3, false),
            Commands.sequence(
