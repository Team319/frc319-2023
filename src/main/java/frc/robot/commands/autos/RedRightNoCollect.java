...
public class RedRightNoCollect extends SequentialCommandGroup {

  Trajectory redRightNoCollect1 = Robot.drivetrain.loadTrajectoryFromFile("redrightnocollect1");

  /** Creates a new RedRight. */
  public RedRightNoCollect() {
