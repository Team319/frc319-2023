...
public class BlueLeftNoCharge extends SequentialCommandGroup {
  /** Creates a new RedRight. */
  private Command runFirstPath(){
    return Commands.sequence(new TestPath(Robot.RedRightNoChargeFirstPath));
  }

  Trajectory blueLeftNoCharge1 = Robot.drivetrain.loadTrajectoryFromFile("blueleftnocharge1");
  Trajectory blueLeftNoCharge2 = Robot.drivetrain.loadTrajectoryFromFile("blueleftnocharge2");
  Trajectory blueLeftNoCharge3 = Robot.drivetrain.loadTrajectoryFromFile("blueleftnocharge3");

  public BlueLeftNoCharge() {
