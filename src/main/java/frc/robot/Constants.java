...
public final class Constants {
    ...
    public static class DriveConstants {
      ...
      public static final double kMaxAccerlationMetersPerSecondSquared = 2.5;
      ...
      public static final double metersPerEncoderTick = Units.inchesToMeters(0.0005371094); // 1/1024
